...
│   └── buddhist.json       # 불교 경전과 게송: 한글 독음, 한자 원문, 우리말 풀이
├── bible/
...
- 금강경, 반야심경, 법성게, 화엄경, 법구경(한역), 육조단경, 선어록 등 저작권이 끝난 한문 원문을 고치지 않고 싣는다. 반야심경과 법성게는 한국 사찰 독송본을 따른다.
- 한글 독음은 한국 사찰의 전통 독음이다. 조계종 표준 한글 번역은 쓰지 않는다.
